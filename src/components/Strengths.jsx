...
export default function Strengths() {
  return (
    <section id="strengths" className="py-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <div className="text-center mb-14">
        <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3 font-['Space_Grotesk']">
          What I <span className="text-[#f59e0b]">Bring</span>
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {strengths.map((item, index) => (
          <div
            key={index}
            className="group bg-[#27272a]/70 border border-[#3f3f46] rounded-2xl p-6
